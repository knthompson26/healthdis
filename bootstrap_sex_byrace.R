...
for (wave in names(waves)) {
  ...
  saveRDS(results, file = paste0("/home/thom1336/healthdis/data/sensitivity/race/sex/bootstrap_results_", wave, race, ".rds"))
  saveRDS(boot_results, file = paste0("/home/thom1336/healthdis/data/sensitivity/race/sex/boot_object_", wave, race, ".rds"))
