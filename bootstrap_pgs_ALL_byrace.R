...
for (wave in names(waves)) {
  for (pgs_var in pgs_vars) {  # NEW LINE: Nested loop over each pgs variable
    ...
    saveRDS(results, file = paste0("/home/thom1336/healthdis/data/sensitivity/race/pgs/bootstrap_results_ALL_", wave, race, "_", pgs_var, ".rds"))
    saveRDS(boot_results, file = paste0("/home/thom1336/healthdis/data/sensitivity/race/pgs/boot_object_ALL_", wave, race, "_", pgs_var, ".rds"))
