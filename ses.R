...
for (wave in names(waves)) {
  for (ses_var in ses_vars) {  # Nested loop over each ses variable
    ...
    saveRDS(results, file = paste0("/home/thom1336/healthdis/data/confound/all/ses/bootstrap_results_", wave, "_", ses_var, ".rds"))
