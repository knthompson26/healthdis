...
for (wave in names(waves)) {
  for (ses_var in ses_vars) {  # NEW LINE: Nested loop over each ses variable
    ...
    saveRDS(results, file = paste0("/home/thom1336/healthdis/data/sensitivity/race/ses/bootstrap_results_", wave, race, "_", ses_var, ".rds"))
    saveRDS(boot_results, file = paste0("/home/thom1336/healthdis/data/sensitivity/race/ses/boot_object_", wave, race, "_", ses_var, ".rds"))
