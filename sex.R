...
for (wave in names(waves)) {
  ...
  # Re-sample individuals 1000 times to capture sampling variability and calculate confidence intervals 
  boot_results <- boot(
  ...
  saveRDS(results, file = paste0("/home/thom1336/healthdis/data/confound/all/sex/bootstrap_results_", wave, ".rds"))
